...
def UDS_SecurityAccess(bus,CanID):
        ...
        print ("SeedVal: 0x%x type: %s" % (SeedVal,type(SeedVal)))         
        SeedValAnswer = BL_Seed(SeedVal)
        print ("SeedValAnswer: 0x%x type: %s" % (SeedValAnswer,type(SeedValAnswer)))
        SeedValAnswerByteArr =  int(SeedValAnswer).to_bytes(4, byteorder='big') 
        #print(SeedValAnswerByteArr)
